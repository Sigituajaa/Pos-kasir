...
// kondisi (wajib absen masuk / jendela absen pulang) berubah, supaya tidak saling tabrakan.
function recomputeDashboardLock() {
    setDashboardLocked(mandatoryMasukGateActive || attendanceOverlayShownType === 'keluar');
}
